                                    ...
                                    @if (Auth::guest())
                                      <li class="hover" ><a style="color: white;" href="{{ url('/login') }}">Login</a></li>
                                        ...
                                        @else
                                          ...
                                          <li class="hover" ><a style="color: white;" href="/auditor")">Dashboard</a></li>
                                          <li class="hover" ><a style="color: white;" href="/auditor/requests">Requests</a></li>
                                          <li class="hover" ><a style="color: white;" href="/auditor/settle" >Business Settlement</a></li>
                                          <li class="hover" ><a style="color: white;" href="/auditor/balance" >Users Balance</a></li>
                                          <li class="hover" ><a style="color: white;" href="/auditor/report" >Monthly Report</a></li>                                          
